...
def computer_level_medium(game):
    ...
    for pop in range(0,2):
        for col in range(game.cols):
            if check_move(game,col,pop):
                simulate_game=simulation(game)
                simulate_game=apply_move(simulate_game,col,pop)
                    ...
                    if pop==1:
                        ...
                        for i in range(simulate_game_pop.cols):
                            if check_move(simulate_game_pop,i,0):
                                simulate_game_pop = apply_move(simulate_game_pop,i,0)
                                if check_victory(simulate_game_pop)!=1:
                                    game=apply_move(game,i,0)
                                    flag=0
                                    indicator=1
                        if flag==1:
